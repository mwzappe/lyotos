...
class BundleHits:
    def __init__(self, bundle):
        self._bundle = bundle
        self._l = cp.ones(bundle.n_rays) * MISS
        self._d = cp.zeros((bundle.n_rays, 4))
        self._p = cp.zeros((bundle.n_rays, 4))
        self._n = cp.zeros((bundle.n_rays, 4))
    ...
    def render(self, renderer):
        ...
        ep = sp + self.l[:,cp.newaxis] * self.bundle.directions
